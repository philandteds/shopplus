...
class eZShopFunctions
{
    ...
    */
    ...
    {
        //return ( $type === 'ezprice' );
        /* ezshopenhancement extension Change */
        $SimplePricedatatypes = eZINI::instance( 'shopplus.ini' )->variable( 'PriceSettings', 'SimplePriceDataType' );
        if(count($SimplePricedatatypes) == 0)
            $SimplePricedatatypes = array('ezprice');
        return in_array($type, $SimplePricedatatypes);
    }
    ...
    static function isMultiPriceProductType( $type )
    {
        ...
        /* ezshopenhancement extension Change */
        $MultiPricedatatypes = eZINI::instance( 'shopplus.ini' )->variable( 'PriceSettings', 'MultiPriceDataType' );
        if(count($MultiPricedatatypes) == 0)
            $MultiPricedatatypes = array('ezmultiprice');
        return in_array($type, $MultiPricedatatypes);
    }
    ...
    */
    static function productDatatypeStringList()
    {
        /*return array( 'ezprice',
                      'ezmultiprice' ); */
        /* ezshopenhancement extension Change */
        $Pricedatatypes = eZINI::instance( 'shopplus.ini' )->variable( 'PriceSettings', 'PriceDataType' );
        if(count($Pricedatatypes) == 0)
            $Pricedatatypes = array( 'ezprice',
                                        'ezmultiprice' );
        return $Pricedatatypes;
